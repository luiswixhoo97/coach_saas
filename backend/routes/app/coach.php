...
Route::prefix('coach')
    ...
    */
    ...
    Route::get('/clientes/{cliente}/formulario-estandar/respuestas', [ControladorFormulario::class, 'respuestasCliente'])
        ->name('coach.clientes.formulario-estandar.respuestas');
