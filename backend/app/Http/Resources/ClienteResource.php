...
class ClienteResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'activo' => $this->activo,
            'pendiente_activacion' => $this->pendiente_activacion,
            'es_nuevo_ingreso' => $this->pendiente_activacion,
            'pendiente_actualizacion' => $this->pendiente_actualizacion,
            'semanas_entre_evaluaciones' => $this->semanas_entre_evaluaciones,
